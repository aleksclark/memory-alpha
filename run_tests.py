...
def main():
    ...
    parser.add_argument("--skip-checks", action="store_true", help="Skip checking services")
    parser.add_argument("--pytest-args", nargs="*", default=[], help="Additional arguments for pytest")
    ...
    if not args.skip_checks:
        ...
        if services_check.returncode != 0:
            print("Some services are not running. Do you want to continue anyway? (y/n)")
