...
def test_ollama_connection():
    ...
    try:
        ...
        assert len(embedding) == settings.embed_dim, f"Expected embedding dimension {settings.embed_dim}, got {len(embedding)}"
...
export default DataFetcher;
        ...
        assert store_result["indexed"] == len(code_samples), "Not all samples were indexed"
